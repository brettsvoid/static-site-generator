...
class TestInlineMarkdown(unittest.TestCase):
    ...
    def test_split_image(self):
        ...
        node2 = TextNode(
            "This is text with an ![image](https://i.imgur.com/zjjcJKZ.png) and some more",
            text_type_text,
        )
    ...
    def test_split_links(self):
        ...
        node2 = TextNode(
            "This is text with a [link](https://www.example.com) and no more",
            text_type_text,
        )
        self.assertListEqual(
            ...
            [
                TextNode("This is text with a ", text_type_text, None),
                TextNode("link", text_type_link, "https://www.example.com"),
                TextNode(" and no more", text_type_text, None),
            ],
        )
